 ...
 * @package kernel
 */
class WurflObject_download extends icms_core_Object
{
...
* @package kernel
*/
class WurflObject_downloadHandler extends icms_ipf_Handler
{
    function __construct(&$db) 
    {
		$this->db = $db;
        parent::__construct($db, "object_download", 'did', '', '', 'wurfl');
    }
}
