...
This is the new standard for gateway and payment solutions with ICMS.
...
that will be released which is compatible with ICMS 2.4 Series, later versions will have the module class wrapper so they 
will not run on ICMS 2.4.
...
Downloads & Demo:
	...
	Sourceforge: http://sourceforge.net/projects/chronolabs/files/ICMS/Modules/xpayment/xoops2.5_xpayment_1.38.zip/download (6.13Mbs)
	...
	Code Example of a Plugin:
		...
		// 'example' is specified in the shopping cart form.  
		    ...
		    function PaidExampleHook($invoice) {  
		        include_once (ICMS_ROOT_PATH.'/modules/xpayment/plugin/xpayment.php');          
